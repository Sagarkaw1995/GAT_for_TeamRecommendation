    ...
    def vae_prediction(self):
        ...
        with open(result_output_name, 'w', newline="") as file:
            ...
            for sample_x, sample_y in zip(self.x_test, self.y_test):
                ...
                #print(sum(sample_prediction[0]))
                auc_list.append(roc_auc_score(sample_y, sample_prediction[0], average='macro', multi_class="ovr"))
                end_time = time.time()
        ...
        print("AUC = " , statistics.fmean(auc_list)*100,"%")
